...
"""
resnet with modulated attention
code:
https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
https://github.com/zhmiao/OpenLongTailRecognition-OLTR/blob/master/models/ResNetFeature.py
"""
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        if self.use_modulatedatt:
            self.modulatedatt = ModulatedAttLayer(planes[3] * block.expansion)
